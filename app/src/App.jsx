...
import solicitarturno from "./Components/solicitoturno";
    ...
    <>
      ...
      <div className="info">
        <div className="imagen-lateral">
          <img src={zoonosis} alt="Icono lateral" />
        </div>
        <h3 className="titulo-resaltado">ZOONOSIS TIGRE</h3>
      </div>
      <br />
      <div className="solicitar-turno"></div>
      <br />
      <div className="row">
        <div className="col-md-6">
          ...
          <ul>
            <li>
              35 turnos de cirug&iacute;a por orden de llegada con el animal en
              la fila a partir de las 8:30 hs (un turno por animal por persona).
            </li>
            <li>Persona mayor de 18 años.</li>
            <li>Concurrir con DNI</li>
            <li>
              Los dueños deberán esperar en el lugar hasta que termine la
              cirugía.
            </li>
            <li>
              En caso de lluvia o mal tiempo, consultar telef&oacute;nicamente
        ...
        <div className="col-md-6">
          ...
          <ul>
            <li>
              Buen estado de salud, con correa y collar, mayores de 6 meses y
              menores de 7 años de edad (machos y hembras).
            </li>
            <li>Ayuno sólido - líquido de 12 hs.</li>
            <li>
              Si han tenido cría, se necesita dejar pasar 60 días luego de la
              fecha del parto.
            </li>
